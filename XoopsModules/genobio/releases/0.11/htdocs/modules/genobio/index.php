<?php
	...
	case "profile":
		...
		$GLOBALS['xoopsTpl']->assign('mother_url', $profile->getVar('dob'));
		$GLOBALS['xoopsTpl']->assign('partner_url', $profile->getVar('dod'));
