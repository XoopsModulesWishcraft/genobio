	...
	case "profiles":	
		...
		switch ($_REQUEST['fct'])
		{
			...
			case "save":			
				...
				$fupload = genobio_uploading('uploads/', $allowedMimeTypes, "index.php?op=profiles&id=".$_REQUEST['id'], 0);
				$baby_photo = $fupload['path'];
				$fupload = genobio_uploading('uploads/', $allowedMimeTypes, "index.php?op=profiles&id=".$_REQUEST['id'], 1);
				$midlife_photo = $fupload['path'];
				$fupload = genobio_uploading('uploads/', $allowedMimeTypes, "index.php?op=profiles&id=".$_REQUEST['id'], 2);
				$elderly_photo = $fupload['path'];
				$fupload = genobio_uploading('uploads/', $allowedMimeTypes, "index.php?op=profiles&id=".$_REQUEST['id'], 3);
				...
				if ($profileshandler->insert($profile))			
